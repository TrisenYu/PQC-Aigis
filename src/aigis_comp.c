...
#define mux(val) \
	return comp_veck_##val(res, a)
	switch(AIGIS_ENC_BITS_PUB) {
	case 9: mux(9);
	case 10: mux(10);
	case 11: mux(11);
	}
...
#define mux(val) \
	return comp_poly_##val(res, a)
	switch(AIGIS_ENC_BITS_CFT2) {
	case 3: mux(3);
	case 4: mux(4);
	case 5: mux(5);
	case 7: mux(7);
