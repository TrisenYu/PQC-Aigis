...
#if AIGIS_ENC_BITS_PUB != 9 && AIGIS_ENC_BITS_PUB != 10 && AIGIS_ENC_BITS_PUB != 11
    #error "unsupported config on AIGIS_ENC_BITS_PUB, " \
           "only accept {9, 10, 11}!"
#endif // check AIGIS_ENC_BITS_PUB for pub_compresser

#if AIGIS_ENC_BITS_CFT != 9 && AIGIS_ENC_BITS_CFT != 10 && AIGIS_ENC_BITS_CFT == 11
    #error "unsupported config on AIGIS_ENC_BITS_CFT, " \
           "only accept {9, 10, 11}!"
#endif // check AIGIS_ENC_BITS_CFT for aigis_cipher_decompresser

#if AIGIS_ENC_BITS_CFT2 != 3 && AIGIS_ENC_BITS_CFT2 != 4 && \
	AIGIS_ENC_BITS_CFT2 != 5 && AIGIS_ENC_BITS_CFT2 != 7
