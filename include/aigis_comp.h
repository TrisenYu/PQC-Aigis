/// Last modified at 2025年07月31日 星期四 17时43分57秒
...
/// 要是c支持curry也不至于这么写
uint8_t sig_poly_eta_s_compresser(uint8_t *res, const sig_poly a);
uint8_t sig_poly_eta_s_decompresser(sig_poly res, const uint8_t *a);
uint8_t sig_poly_eta_e_compresser(uint8_t *res, const sig_poly a);
uint8_t sig_poly_eta_e_decompresser(sig_poly res, const uint8_t *a);
uint8_t sig_poly_t0_compresser(uint8_t *res,const sig_poly a);
uint8_t sig_poly_t0_decompresser(sig_poly res,const uint8_t *a);
void sig_poly_t1_compresser(uint8_t *res, const sig_poly a);
void sig_poly_t1_decompresser(sig_poly res, const uint8_t *a);
void sig_poly_z_compresser(uint8_t *res, const sig_poly a);
void sig_poly_z_decompresser(sig_poly res, const uint8_t *a);
void sig_poly_w1_compresser(uint8_t *res, const sig_poly a);
void sig_poly_w1_decompresser(sig_poly res, const uint8_t *a);
