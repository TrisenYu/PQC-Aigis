...
#define         AIGIS_CRH_SIZE              AIGIS_RNG_SEED_SIZE

// 从噪声生成环上的向量
#define         AIGIS_ENC_ETA_E_INP_SIZE    (AIGIS_ENC_ETA_E*(AIGIS_N>>2))
#define         AIGIS_ENC_ETA_S_INP_SIZE    (AIGIS_ENC_ETA_S*(AIGIS_N>>2))

#define         AIGIS_ENC_PVEC_SIZE         (AIGIS_ENC_K*AIGIS_ENC_POLY_SIZE)
#define         AIGIS_COMP_PUB_SIZE         (AIGIS_ENC_BITS_PUB*AIGIS_ENC_K*(AIGIS_N>>3))
#define         AIGIS_COMP_CFT_SIZE         (AIGIS_ENC_BITS_CFT*AIGIS_ENC_K*(AIGIS_N>>3))
// CFT2对应为多项式形式的密文
#define         AIGIS_COMP_CFT2_SIZE        (AIGIS_ENC_BITS_CFT2*AIGIS_N >> 3)

// 加密标准中的公私钥长度以及密文长度
#define         AIGIS_ENC_PUB_SIZE          (AIGIS_SEED_SIZE+AIGIS_COMP_PUB_SIZE)
#define         AIGIS_ENC_SEC_SIZE          (AIGIS_SEED_SIZE*2+AIGIS_ENC_PUB_SIZE+AIGIS_ENC_PVEC_SIZE)
#define         AIGIS_ENC_CFT_SIZE          (AIGIS_COMP_CFT_SIZE+AIGIS_COMP_CFT2_SIZE)

///
#define         AIGIS_POLY_Z_PK_SIZE        (18*(AIGIS_N>>3))
#define         AIGIS_POLY_W1_PK_SIZE       (3*(AIGIS_N>>3))
#define         AIGIS_POLY_Rq_PK_SIZE       (AIGIS_N*AIGIS_SIG_QBITS>>3)
#define         AIGIS_POLY_T0_PK_SIZE       (AIGIS_N*AIGIS_SIG_D >> 3)
#define         AIGIS_POLY_T1_PK_SIZE       (AIGIS_POLY_Rq_PK_SIZE-(AIGIS_N*AIGIS_SIG_D>>3))
#define         AIGIS_POLY_ETA_S_PK_SIZE    (AIGIS_N*AIGIS_SIG_ETA_S_BITS >> 3)
#define         AIGIS_POLY_ETA_E_PK_SIZE    (AIGIS_N*AIGIS_SIG_ETA_E_BITS >> 3)
#define         AIGIS_PVEC_K_SIZE           (AIGIS_SIG_K*AIGIS_POLY_Rq_PK_SIZE)
#define         AIGIS_PVEC_K_T0_SIZE        (AIGIS_SIG_K*AIGIS_POLY_T0_PK_SIZE)
#define         AIGIS_PVEC_K_T1_SIZE        (AIGIS_SIG_K*AIGIS_POLY_T1_PK_SIZE)
#define         AIGIS_PVEC_K_ETA_E_SIZE     (AIGIS_SIG_K*AIGIS_POLY_ETA_E_PK_SIZE)
#define         AIGIS_PVEC_L_SIZE           (AIGIS_SIG_L*AIGIS_POLY_Rq_PK_SIZE)
#define         AIGIS_PVEC_L_T1_SIZE        (AIGIS_SIG_L*AIGIS_POLY_T1_PK_SIZE)
#define         AIGIS_PVEC_L_ETA_S_SIZE     (AIGIS_SIG_L*AIGIS_POLY_ETA_S_PK_SIZE)
#define         AIGIS_PVEC_L_Z_SIZE         (AIGIS_SIG_L*AIGIS_POLY_Z_PK_SIZE)

#define         AIGIS_PK_PUB_SIZE           (AIGIS_SEED_SIZE + AIGIS_PVEC_K_T1_SIZE)
#define         AIGIS_PK_SEC_SIZE           (           \
    AIGIS_SEED_SIZE * 2 + AIGIS_PVEC_L_ETA_S_SIZE +     \
    AIGIS_PVEC_K_ETA_E_SIZE + AIGIS_CRH_SIZE +          \
    AIGIS_PVEC_K_T0_SIZE                                \
)
#define         AIGIS_PK_SIG_SIZE           (           \
    AIGIS_PVEC_L_Z_SIZE +                               \
